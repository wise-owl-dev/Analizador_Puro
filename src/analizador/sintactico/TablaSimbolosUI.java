    ...
    public void mostrarTabla() {
        ...
        for (SimboloInfo simbolo : tablaSimbolo.getSimbolos()) {
            if (simbolo.getTipo().equals("ROBOT")) {
                System.out.println(String.format("%-15s %-10s %-10s %-10d %-10d",
                        simbolo.getNombre(),
                        simbolo.getTipo(),
        ...
        // Mostrar métodos
        System.out.println("\n--- MÉTODOS ---");
        System.out.println(String.format("%-15s %-10s %-10s %-15s %-15s",
                "NOMBRE", "PARÁMETROS", "VALOR", "RANGO MIN", "RANGO MAX"));
        System.out.println("----------------------------------------------------------------------");

        for (SimboloInfo metodo : tablaSimbolo.getMetodos()) {
            System.out.println(String.format("%-15s %-10d %-10s %-15d %-15d",
                    metodo.getNombre(),
